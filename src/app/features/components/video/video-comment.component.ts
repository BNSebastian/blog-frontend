        ...
        <div class="">
            ...
            <mat-card class="margin-bottom-xsm">
                ...
                <mat-card-actions align="end">
                    ...
                    <button mat-icon-button color="warn" (click)="deleteComment.emit(comment.id)">
...
export class CommentComponent implements OnInit {
    ...
    getReplies(commentId: number): VideoCommentInterface[] {
        return this.comments
            ...
            .sort((a, b) => new Date(a.createdOn).getMilliseconds() - new Date(b.createdOn).getMilliseconds());
    }
    ...
    getParentName() {
        if (this.comment.parentId !== null) {
            this.videoCommentService.getComment(this.comment.parentId).subscribe((response: VideoCommentInterface) => {
